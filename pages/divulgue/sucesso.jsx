...
const PaginaDivulgue = styled.div`
  margin: 4rem 0;
`;
...
export default function DivulgueSucesso() {
  const router = useRouter();

  useEffect(() => {
    async function getLocalStorage() {
      const localData = await JSON.parse(await localStorage.getItem('@voucher/session-sucesso-divulgue'));
      ...
      await localStorage.removeItem('@voucher/session-sucesso-divulgue');
    }
